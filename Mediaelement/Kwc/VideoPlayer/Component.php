<?php
class Mediaelement_Kwc_VideoPlayer_Component extends Kwc_Abstract_Composite_Component
    implements Kwf_Media_Output_IsValidInterface
{
    public static function getSettings($param = null)
    {
        ...
        $ret['generators']['child']['component']['previewImage'] = 'Mediaelement_Kwc_VideoPlayer_PreviewImage_Component';
